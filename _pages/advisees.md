...
- [Mado Ntekouli](https://www.maastrichtuniversity.nl/p70071664) (Postdoc, ongoing): Ecological Momentary Assessment Data  
- [Haoyang Gui](https://www.uu.nl/staff/HGui) (PhD, ongoing): Computational Techniques for Social Media Influencers  
- [Abderrahmane Issam](https://www.maastrichtuniversity.nl/issam) (PhD, ongoing): Low-resource Neural Machine Translation for non-native speakers  
- [Pawel Maka](https://www.maastrichtuniversity.nl/pm-maka) (PhD, ongoing): Context-aware Neural Machine Translation  
- [Samyak Sheth](https://www.maastrichtuniversity.nl/ss-sheth) (PhD, ongoing): Access to legal information for laypeople  
- [Lucas G. Uberti-Bona Marin](https://lucas-ubm.github.io/) (PhD, ongoing): Computational techniques to mitigate risks from AI deployment  


---

## Former PhD / Postdoc advisees

- [Vageesh Saxena](https://www.maastrichtuniversity.nl/p70072497) (PhD, defended 01/2026): Connecting online criminal behavior with machine learning: Using authorship attribution to analyze and link potential online traffickers ([book](https://doi.org/10.26481/dis.20250107vs))  
- [Antoine Louis](https://antoinelouis.co/) (PhD, defended 05/205): Machine Learning Solutions for "Machine learning solutions for improving access to law" ([book](https://cris.maastrichtuniversity.nl/en/publications/machine-learning-solutions-for-improving-access-to-law))
- [Mado Ntekouli](https://www.maastrichtuniversity.nl/p70071664) (PhD, defended 04/2025): Bridging individual and group perspectives in psychopathology: computational modeling approaches using ecological momentary assessment data ([book](https://cris.maastrichtuniversity.nl/en/publications/bridging-individual-and-group-perspectives-in-psychopathology-com))  
- [Constanta Rosca](https://www.universiteitleiden.nl/en/staffmembers/constanta-rosca#tab-1) (PhD, defended 12/2024): Digital Arms for Consumer Harms: Mapping Legal and Technical Solutions for Dark Patterns in EU Consumer Law ([e-book](https://library.maastrichtuniversity.nl/resources/maastricht-university-press/catalog/10-26481-mup-2403/))  
- [Kirill Tumanov](http://tumanov.co/index) (PostDoc, 2020-2021): Combating Childhood Obesity  
...
- **Abdulmuizz Abdulrazzak Khalak (Internship @Law&Tech Lab)**: Identifying factual, legal reasoning and outcome similarities in legal cases (2025)
...
- **Amirhossein Jazayeri (joint s/v with Mado Ntekouli, MSc)**: Clustering and Co-clustering of Multivariate Time-series based on Complex Networks (2024)
...
- **Vitalijs Tickovs (BSc)**: Describing The Language Of Hidden Advertising On Social Media (2024)
...
- **Theodoros Giannilias (MSc)**: MORS: Multi-Output Regression System for Analyzing Airline Customer Satisfaction: A study on Skytrax (2023)
...
- **Joeri Hermans (MSc, joint s/v with Rico Moeckel)**: On Scalable Deep Learning and Parallelizing Gradient Descent algorithm (2017)
- **Darius Schneider (MSc, joint s/v with Mena Habib)**: Enriching Tweet Normalization with Neural Word Embeddings (2017)
- **Maarten Weber (MSc, joint s/v with Kurt Driessens)**: Application of Recurrent Neural Networks on Call Center Data (2017)
